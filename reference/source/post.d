...
class Post {
	...
	string renderSubHeaderAsHtml(SmashFuseSettings settings)
	const {
	...
	string renderContentAsHtml(SmashFuseSettings settings, int header_level_nesting = 0)
	const {
